...
\begin{frame}{Course Structure}
    \begin{itemize}
        ...
        \end{enumerate}
        \pause
        \item \textbf{Materials:} Background notebooks + Exercise notebooks (Available on Itslearning).
        \pause
...
\begin{frame}{Using Generative AI as a Learning Tool}
    \begin{itemize}
        ...
        \pause
        \item \textbf{Usage:} Ask for clarifications, alternative solutions, and code explanations.
        \pause
        \item \textbf{Tools:} 
        \begin{itemize}
            \item \textbf{GPT-UiO:} Free, GDPR-compliant.
            \item \textbf{GitHub Copilot:} Recommended (Free for students).
        \end{itemize}
        \pause
