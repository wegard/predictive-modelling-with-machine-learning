...
\vskip.25in
\noindent\textbf{\large Mini project and presentation} \\
...
-- Lectures are Wednesdays from 12:00--13:45. \\
%-- The lecture plan is preliminary and subject to change. \\
\begin{enumerate}
  \item[] \underline{Lecture 1:} [January 7th] \underline{\bf Introduction and data preprocessing}
    {\small
      \begin{itemize}
        \item Ch. 1 in ESL
  ...
  \item[] \underline{Lecture 2:} [January 14th] \underline{\bf Machine learning basics and supervised learning}
    {\small
      \begin{itemize}
  ...
  \item[] \underline{Lecture 3:} [January 21st] \underline{\bf LDA and regularized regression analysis}
    {\small
      \begin{itemize}
...
\item [] \underline{Lecture 4:} [January 28th] \underline{\bf Classification analysis}
        {\small
          \begin{itemize}
  ...
  \item[] \underline{Lecture 5:} [February 4th] \underline{\bf Model selection, evaluation and assessment}
    {\small
      \begin{itemize}
        \item Ch. 7 in ESL
  ...
  \item[] \underline{Lecture 6:} [February 11th] \underline{\bf Unsupervised learning}
    {\small
      \begin{itemize}
  ...
  \item[] \underline{Lecture 7:} [February 18th] \underline{\bf Ensemble methods and Random forests}
    {\small
      \begin{itemize}
        \item Ch. 8, 10, 15 and 16 in ESL
        \item Notebooks \texttt{12\_Introducing\_ensemble\_methods.ipynb}, \texttt{13\_Random\_forests.ipynb}
        %\texttt{13\_Bagging.ipynb}, \texttt{14\_Random\_forests.ipynb}, \texttt{15\_ExtraTrees.ipynb}
        \item Exercise: \texttt{07\_Predicting\_income.ipynb}, \texttt{08\_Predicting\_credit\_risk.ipynb}
      \end{itemize}
    }
  \item[] \underline{Lecture 8:} [February 25th] \underline{\bf Backpropagation and gradient descent}
    {\smallxs
      \begin{itemize}
        \item Ch. 11 in ESL
        \item Notebooks: \texttt{16\_Gradient\_Decent.ipynb}, \texttt{17\_Backpropagation.ipynb}
        \item Exercise: TBA
      \end{itemize}
    }
  \item[] \underline{Lecture 9:} [March 4th] \underline{\bf PyTorch and neural networks}
    {\small
      \begin{itemize}
        \item Chapter 11 in ESL
        \item Notebooks: \texttt{18\_NN\_Basics.ipynb}
        \item Exercise: \texttt{09\_Neural\_Networks\_with\_PyTorch.ipynb}
      \end{itemize}
    }
  \item[] \underline{Lecture 10:} [March 11th] \underline{\bf Traditional ML vs Deep Learning}
    {\small
      \begin{itemize}
        \item Ch. 11 in ESL
        \item Notebooks: TBA
  ...
  \item[] \underline{Lecture 11:} [March 18th] {\bf Presentation and defense of the mini projects}
  \item[] \underline{Lecture 12:} [March 25th] {\bf Summing up and Q\&A}
\end{enumerate}
...
\begin{itemize}
  ...
  \item Start: 26.05.2026 at 09:00
  \item Submission deadline: 27.05.2026 at 15:00
  \item Weight: 70\%
\end{itemize}
