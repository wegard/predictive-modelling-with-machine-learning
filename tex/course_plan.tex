...
\begin{document}
\begin{center}
{\LARGE \textsc{Advanced Regression and Classification Analysis, Ensemble Methods and Neural Networks}}
\end{center}
\begin{center}
 ...
 \item[] \underline{Lecture 5:} [February 16th] \underline{\bf Model selection, evaluation and assessment}
  ...
  {\small
          \begin{itemize}
            ...
            \item Notebooks: \texttt{17\_Stochastic\_gradient\_decent.ipynb}, \texttt{18\_Backpropagation.ipynb}
            \item Exercise: \texttt{09\_Neural\_Networks\_with\_Keras\_I.ipynb}
          \end{itemize}
  }
  \item[] \underline{Lecture 10:} [March 23rd] \underline{\bf Neural networks II}
    {\small
          \begin{itemize}
            \item Ch. 11 in ESL
  ...
  \item[] \underline{Lecture 11:} [March 30th] {\bf Presentation and defense of the mini projects}
  \item[] \underline{Lecture 12:} [April 13th] {\bf Summing up and Q\&A}
\end{enumerate}
...
\begin{itemize}
    ...
    \item Start: 24.05.2023 at 09:00
    \item Submission deadline: 25.05.2023 at 15:00
    \item Weight: 70\%
\end{itemize}
...
\vskip.25in
\noindent
We will also rely on some third party Python libraries. I recomend spending some time familiarizing yourself with the following libraries:
