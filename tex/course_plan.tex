...
\textbf{Office:}       & B3Y-075          & \textbf{Office Hours:}  & TBA \medskip \\
...
\begin{enumerate}
 ...
 \item[] \underline{Lecture 5:} [February 8th] \underline{\bf Model selection, evaluation and assessment}
  ...
  \item[] \underline{Lecture 10:} [March 14rd] \underline{\bf Neural networks II}
    {\small
          \begin{itemize}
            \item Ch. 11 in ESL
  ...
  \item[] \underline{Lecture 11:} [March 21th] {\bf Presentation and defense of the mini projects}
  \item[] \underline{Lecture 12:} [April 4th] {\bf Summing up and Q\&A}
\end{enumerate}
